...
public class CheckHotel extends JFrame implements Runnable {
    ...
    public void run() {
        String[] text = new String[]{"RR Marriout Hotel", "Shinde Hotel", "Madarin Oriental Hotel", "Four Seasons Hotel", "Raddiason Rise Hotel", "Ciasssio Hotel", "The bay Club Hotel", "Thr Taj Hotel", "Breeze Blow Hotel", "Sky View Hotel"};
        try {
            for (int i = 0; i <= 9; i++) {
